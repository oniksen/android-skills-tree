...
export default function SkillRow({ skillId, name, maxWeight, currentScore, required }: {
  skillId: string; name: string; maxWeight: number; currentScore: number; required: boolean;
}) {
