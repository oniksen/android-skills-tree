...
('Middle', 'middle', 250, 700, 2, 2, 'Разработчик уверенно решает типовые задачи, работает с API и базами данных. Самостоятельно разрабатывает production-ready приложения.'),
('Strong Middle', 'strong-middle', 700, 1000, 3, 3, 'Проектирует архитектуру, работает с многомодульностью и производительностью.'),
('Senior', 'senior', 1000, 1400, 4, 5, 'Способен проектировать архитектуру продукта и принимать технические решения масштаба компании.');
