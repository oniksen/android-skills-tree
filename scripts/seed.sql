...
('Junior', 'junior', 0, 250, 1, 0, 'Разработчик способен создавать простые Android-приложения и понимает основные механизмы платформы.'),
('Junior+', 'junior-plus', 250, 450, 2, 1, 'Разработчик уверенно решает типовые задачи, работает с API и базами данных.'),
('Middle', 'middle', 450, 700, 3, 2, 'Самостоятельно разрабатывает production-ready приложения.'),
('Strong Middle', 'strong-middle', 700, 1000, 4, 3, 'Проектирует архитектуру, работает с многомодульностью и производительностью.'),
('Senior', 'senior', 1000, 1400, 5, 5, 'Способен проектировать архитектуру продукта и принимать технические решения масштаба компании.');
